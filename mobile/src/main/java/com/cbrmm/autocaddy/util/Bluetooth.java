...
public class Bluetooth {
    ...
    public final static String TRANSMISSION_DATA_SIGNAL = String.valueOf((char) 14);
    public final static String TRANSMISSION_HEIGHT_SIGNAL = String.valueOf((char) 15);
	...
	public void send(Data data) {
		try {
			out.write(data.getDataArrForTransmission());
		} catch(IOException e) {
			connected = false;
			if(deviceCallback != null){
				ThreadHelper.run(runOnUi, activity,
